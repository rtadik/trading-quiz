  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="mt-6 bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-semibold px-8 py-3 rounded-xl hover:from-blue-500 hover:to-cyan-400 transition-all duration-200 flex items-center gap-2"
      >
        Continue
