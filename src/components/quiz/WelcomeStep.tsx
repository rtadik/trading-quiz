  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        <button
          onClick={onStart}
          className="w-full sm:w-auto bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-semibold text-lg px-8 py-4 rounded-xl hover:from-blue-500 hover:to-cyan-400 transition-all duration-200 shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 hover:scale-105"
        >
          Start the Quiz
        </button>
